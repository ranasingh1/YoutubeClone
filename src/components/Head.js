...
const Head = () => {
  ...
  return (
    <div className="grid  fixed bg-white w-screen grid-flow-col p-4  top-0 ">
      ...
      {true && suggestion.length>0 && (
        <div className="absolute  z-50 max-sm:w-[100%]   md:translate-x-[18rem] lg:translate-x-[21rem] top-[4.1rem] bg-gray-50  py-2 px-2 w-[33rem] rounded-lg">
          <ul>
            {suggestion?.map((s, i) => (
              // <Link to = "/results">
